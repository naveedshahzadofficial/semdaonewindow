...
onMounted(() => {
  window.scrollTo(0, 0);
  emit("background", require('@/assets/images/Trading-Services-background-image.jpg'));
  emit("breadcrumbs", [
...
<template>
  <section class="px-4 py-8">
    ...
    <div class="px-8 py-8 min-h-[500px] grid grid-cols-3">
      ...
      <div class="h-[388px] w-[370px] bg-[url('@/assets/images/Trading-Services-side.png')] bg-cover bg-no-repeat rounded-2xl"></div>
    </div>
  </section>
</template>
